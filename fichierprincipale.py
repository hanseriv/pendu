...
while(1):
    if as_it_began == False:
        ...
        mf.void_afficher_mot(unsigned_int_indicator_victory, list_char_lettre_joueur, list_char_lettre_joueur_fausse,list_char_lettre_du_mot)
        ...
        while mf.bool_is_it_a_char(char_letter_chosen) != True:
            ...
            char_letter_chosen = input("veuillez entrer une lettre :")
        unsigned_int_live,list_char_lettre_joueur = mf.void_letter_checker_function(char_letter_chosen,unsigned_int_live,list_char_lettre_joueur,list_char_lettre_du_mot,list_char_lettre_joueur_fausse)